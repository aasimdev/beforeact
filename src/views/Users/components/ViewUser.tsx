...
const ViewUser: React.FC<ViewUserDT> = (props) => {
        ...
        <div className="max-w-[632px] mx-auto">
          <div className="flex justify-between px-10">
            <div className="text-center">
              <div className="bg-purple-100 w-[120px] h-[120px] mx-auto rounded-lg flex items-center justify-center">
                <i className="bx bx-user text-6xl text-blue"></i>
              </div>
              <p className="my-2.5 text-gray-200 text-[22px] leading-none">
                Username
              </p>
              <span className="text-gray text-lg">admin</span>
            </div>
            <div className="text-center">
              <div className="bg-purple-100 w-[120px] h-[120px] mx-auto rounded-lg flex items-center justify-center">
              ...
              <span className="text-gray text-lg">admin@casino.com</span>
            </div>
            <div className="text-center">
              <div className="bg-purple-100 w-[120px] h-[120px] mx-auto rounded-lg flex items-center justify-center">
              ...
              <span className="text-gray text-lg">01/01/2024</span>
            </div>
          </div>
